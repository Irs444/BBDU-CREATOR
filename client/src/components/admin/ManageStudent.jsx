                    ...
                    userList.map((pod) => {
                        return <tr style={{ fontFamily: "initial" }} >
                            ...
                            <td>
                                ...
                                <Link href=""> <i class="bi bi-trash3 fs-4 text-danger" onClick={e => deleteUser(pod._id)}></i></Link>
                            </td>
                        </tr>
                    })
                }
    ...
    return (
        <div>
            <div className='container'>
                <h1 className='text-center fw-bold my-4 fs-2' style={{ fontFamily: "initial", color: "teal" }}>Manage User</h1>
                {displayUserData()}
            </div>
        </div>
    )
